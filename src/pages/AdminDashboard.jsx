              ...
              <Card.Header className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <Card.Subtitle className="text-muted">
                    Administra los docentes registrados en el sistema
                  </Card.Subtitle>
                </div>
            ...
            <Card>
              <Card.Header className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <Card.Subtitle className="text-muted">Administra los alumnos registrados en el sistema</Card.Subtitle>
                </div>
            ...
            <Card>
              <Card.Header className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <Card.Subtitle className="text-muted">Administra los grupos y asignaciones</Card.Subtitle>
                </div>
